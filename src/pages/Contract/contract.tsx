...
<p style="margin: 5px 0;">Ông: ${data.seller.fullName.toUpperCase()} Sinh ngày: ${data.seller.dateOfBirth}</p>
<p style="margin: 5px 0;">CMND: ${data.seller.idNumber} cấp ngày: ${data.seller.idIssueDate} tại: ${data.seller.idIssuePlace.toUpperCase()}</p>
<p style="margin: 5px 0;">Hộ khẩu thường trú: ${data.seller.permanentAddress}</p>
<p style="margin: 5px 0;">Cùng vợ là bà: ${data.seller.spouseName?.toUpperCase()}</p>
<p style="margin: 5px 0;">Sinh ngày: ${data.seller.spouseDateOfBirth}</p>
<p style="margin: 5px 0;">CMND: ${data.seller.spouseIdNumber} cấp ngày: ${data.seller.spouseIdIssueDate} tại: ${data.seller.spouseIdIssuePlace?.toUpperCase()}</p>
...
<p style="margin: 5px 0;">Ông: ${data.buyer.fullName.toUpperCase()} Sinh ngày: ${data.buyer.dateOfBirth}</p>
<p style="margin: 5px 0;">CMND: ${data.buyer.idNumber} Cấp ngày: ${data.buyer.idIssueDate} tại: ${data.buyer.idIssuePlace.toUpperCase()}</p>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="text-center">
            <p className="text-gray-600 mb-6">
              Nhấn nút bên dưới để tự động tạo và in hợp đồng mua bán xe
            </p>
